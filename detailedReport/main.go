...
func main() {
	...
	sangareddyDist["Narayankhed SD"] = []mndlHabs{mndlHabs{mandalName: "Sirgapur", totalHabs: 23}, mndlHabs{mandalName: "Manoor", totalHabs: 33}, mndlHabs{mandalName: "Kalher", totalHabs: 49}, mndlHabs{mandalName: "Kangti", totalHabs: 52}, mndlHabs{mandalName: "Nagalagidda", totalHabs: 62}, mndlHabs{mandalName: "Narayankhed", totalHabs: 88}}
	...
	mdkDist["Medak SD"] = []mndlHabs{mndlHabs{mandalName: "Alladurg", totalHabs: 28}, mndlHabs{mandalName: "REGODE", totalHabs: 26}, mndlHabs{mandalName: "Shankarampet(A)", totalHabs: 41}, mndlHabs{mandalName: "HAVELI GANPUR", totalHabs: 63}, mndlHabs{mandalName: "TEKMAL", totalHabs: 64}, mndlHabs{mandalName: "Medak", totalHabs: 44}, mndlHabs{mandalName: "Papannapet", totalHabs: 58}}
