...
func main() {
	...
	mdkDist["Medak SD"] = []mndlHabs{mndlHabs{mandalName: "Alladurg", totalHabs: 26}, mndlHabs{mandalName: "REGODE", totalHabs: 28}, mndlHabs{mandalName: "Shankarampet(A)", totalHabs: 41}, mndlHabs{mandalName: "HAVELI GHANPUR", totalHabs: 63}, mndlHabs{mandalName: "TEKMAL", totalHabs: 64}, mndlHabs{mandalName: "Medak", totalHabs: 44}, mndlHabs{mandalName: "Papannapet", totalHabs: 58}}
